...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("skaffolder_test_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("skaffolder_test.config") // Configuration fileName without the .TOML or .YAML extension
	}
